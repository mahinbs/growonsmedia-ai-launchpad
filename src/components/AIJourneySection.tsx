import { Search, TrendingUp, Zap, ChevronDown } from "lucide-react";
...
const AIJourneySection = () => {
  ...
  const steps = [
    {
      ...
      details:
        "We dive deep into your current processes to identify where AI can make the biggest impact on your business efficiency and growth.",
      image: analyzeImg,
      letter: "A",
    },
    {
      ...
      details:
        "Our experts analyze potential returns, implementation complexity, and your organization's readiness for AI transformation.",
      image: evaluateImg,
      letter: "E",
    },
    {
      ...
      details:
        "We build, test, and deploy custom AI solutions that integrate smoothly with your existing systems and workflows.",
      image: developImg,
      letter: "D",
    },
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (!sectionRef.current || isMobile) return; // Disable auto-scroll on mobile
      ...
      if (rect.top <= triggerPoint && rect.bottom >= 0) {
        ...
        const scrollProgress = Math.max(
          0,
          Math.min(1, (triggerPoint - rect.top) / (sectionHeight * 0.8))
        );
  ...
  return (
    <section
      id="journey"
      ref={sectionRef}
      className="py-32 bg-muted/30 overflow-hidden"
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-20 fade-in">
          <h2 className="text-4xl lg:text-6xl mb-6 max-w-4xl mx-auto">
            From Vision to Reality: Your{" "}
            <span className="gradient-text">3-Step AI-Transformation</span>{" "}
            Journey
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We guide you through a proven process that transforms your business
            with AI-driven solutions, ensuring maximum impact and seamless
            integration.
          </p>
        </div>
