...
import { CheckCircle2, ArrowLeft, Mail, MessageCircle, Sparkles } from "lucide-react";
    ...
    <section className="min-h-[80vh] flex items-center justify-center py-20 px-6">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              >
                Thank you for reaching out to Growonsmedia! Our AI experts are reviewing
                your inquiry and will contact you soon to discuss how we can transform your
